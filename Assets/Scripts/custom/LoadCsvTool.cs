...
public class LoadCsvTool : MonoBehaviour
{

    public static LoadCsvTool _instance;
    public static LoadCsvTool GetInstance()
    {
        if (_instance == null)
        {
            _instance = new LoadCsvTool();
        }
        return _instance;
    ...
    public static Dictionary<int, T_CsvData> LoadCsv<T_CsvData>(string csvFilePath)
    {
        #region
        /* CSV文件路径 */
